...
Implement a NFT artwork platform which satisfied security requirements and design some security mechanisms
...
* Unzip the folder and put to server's directory
* If php's package is not working, add following lines to your composer.json file
...
* include "{Your_Dir}/vendor/autoload.php"    
## Setup Database
...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2022 at 04:45 PM
